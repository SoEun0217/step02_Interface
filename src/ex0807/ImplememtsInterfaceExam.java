...
interface InterfaceExam00{
	//모든 메소드는 public abstract이다.=추상메소드이다.
	//모든 변수는 public static final이다=상수이다.
	//단,1.8version부터는 default,static메소드 추가(body{}있는 메소드)
	abstract void interfaceExam00();
}


interface InterfaceExam01 extends InterfaceExam00{//상속 생성x,구현(implements)한다.
	//같은 interface끼리 상속가능
	final int i = 767;
